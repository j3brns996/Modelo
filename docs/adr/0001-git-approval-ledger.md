...
- Remote protections require separate host evidence. `modelo platform capabilities`
  is an unimplemented launch target, not an available command. See the launch runbook.
