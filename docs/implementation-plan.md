...
| T7-UX | Guided GitHub Issue Forms, trusted default-branch intake compiler/action and decision-led PR templates | T7, T8-premerge | Human fields compile to the existing schema-valid payload; source binding, invalid edits, least permissions, action pinning and single-comment updates pass |
