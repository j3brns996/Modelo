...
For proposal drafting, start with the [interactive helper](/Modelo/propose/#builder) or read the repository's `docs/authoring.md`. The page keeps all five governed operations in its static chooser. The default form asks for business need, intended use, known vendor/model details, and where/when. Optional choices capture rights-owner domicile, operator, and processing territory. The detailed composer covers all five operations.
